...
class OrtHelper {
public:
    OrtHelper(std::string model_path) {
...
private:
    ...
    std::vector<std::string> input_names_ = {"pf_points", "pf_features", "pf_vectors", "pf_mask"};
    std::vector<std::vector<int64_t>> input_shapes_ = {{1, 2, 128}, {1, 17, 128}, {1, 4, 128}, {1, 1, 128}}; // (batch_size=1, channel, length)
