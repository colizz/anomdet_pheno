...
{
  // // simply print all particles within the three classes
  ...
  //   cout << "stableParticleOutputArray: " << candidate->PID << " " << candidate->Status << " " << candidate->Momentum.Pt() << " " << candidate->Momentum.Eta() << " " << candidate->Momentum.Phi() << endl;
  // }
  // for(int i = 0; i < allParticleOutputArray->GetEntries(); ++i)
  // {
  //   Candidate *candidate = static_cast<Candidate *>(allParticleOutputArray->At(i));
  //   cout << "allParticleOutputArray: " << candidate->PID << " " << candidate->Status << " " << candidate->Momentum.Pt() << " " << candidate->Momentum.Eta() << " " << candidate->Momentum.Phi() << endl;
  // }
  // for(int i = 0; i < partonOutputArray->GetEntries(); ++i)
  // {
  //   Candidate *candidate = static_cast<Candidate *>(partonOutputArray->At(i));
  //   cout << "partonOutputArray: " << candidate->PID << " " << candidate->Status << " " << candidate->Momentum.Pt() << " " << candidate->Momentum.Eta() << " " << candidate->Momentum.Phi() << endl;
  // }
  return true;
}
...
// {
//   bool pass = false;
//   TObjArray *fatjets = modularDelphes->ImportArray("JetEnergyScalePUPPIAK8/jets");

//   for(int i = 0; i < fatjets->GetEntries(); ++i) {
//     Candidate *candidate = static_cast<Candidate *>(fatjets->At(i));
//     if (candidate->Momentum.Pt() >= 200 && std::abs(candidate->Momentum.Eta()) < 2.5) {
//       pass = true;
//       break;
//     }
//   }
...
{
  return (passIsoEle32Filter(modularDelphes) || passIsoMu24Filter(modularDelphes));
}
