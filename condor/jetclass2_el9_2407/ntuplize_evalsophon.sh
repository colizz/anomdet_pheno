...
JOBNUM=$1
JOBBEGIN=$2
FILELIST=$3 #samples/eval_higgs_filelist.txt
MACHINE=$4
SCRIPT_NAME=$5
if [[ -z $SCRIPT_NAME ]]; then
    SCRIPT_NAME=makeNtuplesEvalSophonFatJet.C
fi
...
# run ntuplizer
root -b -q $NTUPLIZER_FILE_PATH'+("'$dir_path_new/$file_name'", "out.root", "'$MODEL_AK8_PATH'", "JetPUPPIAK8")'
