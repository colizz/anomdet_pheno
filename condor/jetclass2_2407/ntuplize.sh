...
if [[ $MACHINE == "ihep" ]]; then
    ...
    NTUPLIZER_FILE_PATH=/publicfs/cms/user/licq/pheno/anomdet/jetclass2_generation/delphes_ana/$SCRIPT_NAME
fi
...
root -b -q $NTUPLIZER_FILE_PATH'+("'$dir_path_new/$file_name'", "'$dir_path_ntuple/${file_name/events_delphes/ntuples}'", "JetPUPPIAK8", "GenJetAK8", '$assign_qcd')'
